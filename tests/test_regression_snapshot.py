...
EXPECTED_PM8_PERMISSIVE_SWAPPED_FOR_PROPRIETARY_BLOCKS = "< file license/copyright check > ┌───────────────────────────────────────────┐\n< file license/copyright check > │           **Flagged Files Report**         │\n< file license/copyright check > ├───────────────────────────────────────────┤\n< file license/copyright check > │\n< file license/copyright check > │ 📖 For more information, see: COMPLIANCE.md\n< file license/copyright check > │    https://github.com/qualcomm/copyright-license-checker-action/blob/main/COMPLIANCE.md\n< file license/copyright check > ├───────────────────────────────────────────┤\n< file license/copyright check > │\n< file license/copyright check > │ ═══════════════════════════════════════════\n< file license/copyright check > │ 🚨  B L O C K I N G   E R R O R S\n< file license/copyright check > │ ═══════════════════════════════════════════\n< file license/copyright check > │\n< file license/copyright check > │ ┌─ 📄 F I L E: src/core.cpp\n< file license/copyright check > │ │\n< file license/copyright check > │ ├─ 🚨 LICENSE ISSUES:\n< file license/copyright check > │ │  • License deleted: MIT and license added: LicenseRef-scancode-proprietary-license -- a permissive license's attribution terms are not extinguished by marking the file proprietary; restore the deleted license, or route the change to the scan team/legal if the file's licensing has genuinely changed.\n< file license/copyright check > │ └─────────────────────────────────────────\n< file license/copyright check > └───────────────────────────────────────────┘\n"  # noqa: E501
EXPECTED_PM8_PERMISSIVE_SWAPPED_FOR_PROPRIETARY_BLOCKS_CODE = 1

EXPECTED_PM9_MARKER_STRIPPED_FROM_COMPOUND_BLOCKS = "< file license/copyright check > ┌───────────────────────────────────────────┐\n< file license/copyright check > │           **Flagged Files Report**         │\n< file license/copyright check > ├───────────────────────────────────────────┤\n< file license/copyright check > │\n< file license/copyright check > │ 📖 For more information, see: COMPLIANCE.md\n< file license/copyright check > │    https://github.com/qualcomm/copyright-license-checker-action/blob/main/COMPLIANCE.md\n< file license/copyright check > ├───────────────────────────────────────────┤\n< file license/copyright check > │\n< file license/copyright check > │ ═══════════════════════════════════════════\n< file license/copyright check > │ 🚨  B L O C K I N G   E R R O R S\n< file license/copyright check > │ ═══════════════════════════════════════════\n< file license/copyright check > │\n< file license/copyright check > │ ┌─ 📄 F I L E: src/core.cpp\n< file license/copyright check > │ │\n< file license/copyright check > │ ├─ 🚨 LICENSE ISSUES:\n< file license/copyright check > │ │  • License deleted: MIT AND LicenseRef-scancode-proprietary-license and license added: LicenseRef-scancode-proprietary-license -- a permissive license's attribution terms are not extinguished by marking the file proprietary; restore the deleted license, or route the change to the scan team/legal if the file's licensing has genuinely changed.\n< file license/copyright check > │ └─────────────────────────────────────────\n< file license/copyright check > └───────────────────────────────────────────┘\n"  # noqa: E501
...
class TestProprietaryModeScenarios(RegressionSnapshotTestCase):
    ...
    def test_pm8_permissive_swapped_for_proprietary_blocks(self):
        ...
        relicensing third-party code as proprietary is reported -- with its own
        message naming the attribution hazard, rather than the generic
        "license added: LicenseRef-scancode-proprietary-license" phrasing that
        reads as though a different real license had been substituted.
        """
        output, code = self.run_main(
            patches.ADDITION_AND_DELETION,
